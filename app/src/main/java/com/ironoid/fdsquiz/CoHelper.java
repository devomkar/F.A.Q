...
public class CoHelper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    // Database Name
    private static final String DATABASE_NAME = "coquiz";
    // tasks table name
    ...
    private SQLiteDatabase codbase;
    public CoHelper(Context context) {
    ...
    {
        Question q1=new Question("Which is is company is the largest manufacturer" +
                " of network equipment?","HP", "IBM", "CISCO", "DELL", "CISCO");
        this.addQuestion(q1);
    ...
    public void addQuestion(Question quest) {
        ...
        // Inserting Row
        codbase.insert(TABLE_QUEST, null, values);
    }
    public List<Question> getAllQuestions() {
        List<Question> quesList = new ArrayList<Question>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_QUEST;
        codbase=this.getReadableDatabase();
        Cursor cursor = codbase.rawQuery(selectQuery, null);
