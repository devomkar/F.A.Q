...
public class deldhelper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    // Database Name
    private static final String DATABASE_NAME = "deldquiz";
    // tasks table name
    ...
    public deldhelper(Context context) {
    ...
    private void addQuestions()
    {
        Question q1=new Question("1. Which of the following data structure is" +
                "  non-linear type?","Tree", "Array", "CISCO", "DELL", "CISCO");
        this.addQuestion(q1);
